...
const sessions = [
  ...
  },
  {
    date: 'Jul 02',
    time: '02:00 PM',
    title: 'Checklist Signoff Window',
    site: 'Faculty Review Room',
    students: 15,
  },
] as const;
...
const studentsNeedingReview = [
  ...
  {
    name: 'Elena Ford',
    issue: 'Credential packet uploaded for review',
        ...
        <div className="grid grid-cols-12 gap-6">
          ...
          <section className="col-span-12 grid grid-cols-2 gap-4 lg:col-span-4">
            {metrics.map((metric) => (
              <div
                key={metric.label}
                className="rounded-[20px] border border-border-subtle bg-surface p-5 shadow-soft"
              >
                <p className="font-mono text-[11px] uppercase tracking-[0.12em] text-on-surface-variant">
                  {metric.label}
                </p>
                <p className={`mt-2 font-mono text-[28px] font-semibold ${metric.tone}`}>
                  {metric.value}
                </p>
              </div>
            ))}
                  ...
                  <table className="w-full">
                    <thead>
                      <tr className="border-b border-border-subtle bg-surface-muted">
                        <th className="px-6 py-4 text-left text-sm font-bold text-on-surface">
                          Student
                        </th>
                        <th className="px-6 py-4 text-left text-sm font-bold text-on-surface">
                          Hours
                        ...
                        <th className="px-6 py-4 text-center text-sm font-bold text-on-surface">
                          Action
                        </th>
                      </tr>
                    </thead>
                  ...
                  {studentsStats.map((student) => (
                    ...
                    >
                      ...
                      <div className="grid grid-cols-2 gap-4 mb-3">
                        <div>
                          <p className="text-[11px] font-bold text-on-surface-variant uppercase mb-1">
                            Hours
                          </p>
                          <div className="h-1.5 rounded-full bg-surface-container overflow-hidden">
                            <div
                              ...
                              style={{
                                width: `${(student.hoursLogged / student.hoursRequired) * 100}%`,
                              }}
                            />
                          </div>
                  ...
                  >
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        <h5 className="text-[17px] font-semibold text-on-surface">
                          {action.title}
                        </h5>
                  ...
                  >
                    <div className="flex items-center justify-between gap-4">
                      <div>
                        ...
                        <h5 className="mt-1 text-[15px] font-semibold text-on-surface">
                          {session.title}
                        </h5>
          ...
          <section className="col-span-12 lg:col-span-8">
            <div className="rounded-[20px] border border-border-subtle bg-surface p-6 shadow-soft">
              <div className="mb-5 flex items-center justify-between">
                <h4 className="font-display text-[22px] font-semibold">
                    ...
                    <div>
                      <div className="flex justify-between items-center mb-2">
                        ...
                        <span className="font-mono font-bold text-on-surface">
                          {selectedStudent.hoursLogged}/{selectedStudent.hoursRequired}h
                        </span>
                      </div>
                      <div className="h-3 rounded-full bg-surface-container overflow-hidden">
                        <div
                          className="h-full bg-secondary transition-all"
                          style={{
                            width: `${(selectedStudent.hoursLogged / selectedStudent.hoursRequired) * 100}%`,
                          }}
                        />
                      </div>
                    </div>
                    <div className="grid grid-cols-2 gap-3 mt-4">
                      <div className="rounded-[12px] bg-surface-muted p-3">
                        ...
                        <p className="font-mono text-xl font-bold text-secondary">
                          {selectedStudent.hoursLogged}h
                        </p>
                      </div>
                      <div className="rounded-[12px] bg-surface-muted p-3">
                        <p className="text-[11px] text-on-surface-variant uppercase mb-1">
                          Remaining
                        </p>
                        <p className="font-mono text-xl font-bold text-warning">
                          {selectedStudent.hoursRequired - selectedStudent.hoursLogged}h
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="rounded-[16px] border border-border-subtle p-4">
                  ...
                  <div>
                    <div className="flex justify-between items-center mb-2">
                      ...
                      <span className="font-mono font-bold text-on-surface">
                        {selectedStudent.checklistCompletion}%
                      </span>
                    </div>
                    <div className="h-3 rounded-full bg-surface-container overflow-hidden">
                      <div
                    ...
                    {selectedStudent.status === 'On Track' ? (
                      <>
                        ...
                        <div>
                          ...
                          <p className="text-sm text-on-surface-variant mt-1">
                            Student is maintaining good progress. Continue current support plan.
                          </p>
                        </div>
                      </>
                    ) : selectedStudent.status === 'At Risk' ? (
                      <>
                        ...
                        <div>
                          ...
                          <p className="text-sm text-on-surface-variant mt-1">
                            Student needs additional support. Schedule a check-in this week.
                          </p>
                        </div>
                      </>
                    ) : (
                      <>
                        ...
                        <div>
                          ...
                          <p className="text-sm text-on-surface-variant mt-1">
                            Keep close watch on clinical hours. Student needs to increase pace.
                          </p>
                        </div>
                      </>
                    )}
