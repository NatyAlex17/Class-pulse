...
@Module({
  ...
  providers: [Reflector, SupabaseAuthGuard, ExamConfigService, EnrollmentWizardConfigService, OrientationSurveyConfigService, LearningResourcesConfigService, CohortsConfigService, IntakeSubmissionService, StudentPortalRepository, StudentPortalService],
